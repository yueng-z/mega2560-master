...
#endif
#ifdef USE_FONT_6X8
   const UG_FONT FONT_6X8 = {(const unsigned char*)font_6x8,6,8};
#endif
#ifdef USE_FONT_6X10
...
#endif
#ifdef USE_FONT_8X8
   const UG_FONT FONT_8X8 = {(const unsigned char*)font_8x8,8,8};
#endif
#ifdef USE_FONT_8X12
...
#endif
#ifdef USE_FONT_10X16
   const UG_FONT FONT_10X16 = {(const unsigned char*)font_10x16,10,16};
#endif
#ifdef USE_FONT_12X16
...
UG_RESULT UG_WindowCreate( UG_WINDOW* wnd, UG_OBJECT* objlst, UG_U8 objcnt, void (*cb)( UG_MESSAGE* ) )
{
   ...
   wnd->title.ifc = C_BLACK;
   wnd->title.ibc = C_WHITE;
   wnd->title.height = 15;
