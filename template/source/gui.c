...
void ll_lcd()
{
    LCD_Clear(WHITE);
    DrawTestPage("龙！");
    Gui_Drawbmp16(30,30,gImage_111);
    Gui_StrCenter(0,30,BLACK,WHITE,"实践课程设计",24,1);//居中显示
    Gui_StrCenter(0,60,BLACK,WHITE,"龙里奥",32,1);//居中显示
    Gui_StrCenter(0,100,BLACK,WHITE,"陈政烨",16,1);//居中显示
    Gui_StrCenter(0,120,BLACK,WHITE,"张伟彦",16,1);//居中显示
    Gui_StrCenter(0,140,BLACK,WHITE,"杨永正",16,1);//居中显示
}
#endif